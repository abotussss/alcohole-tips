  ...
  return (
    <main className="px-5 pb-16 pt-8 sm:px-8 lg:px-10">
      <section className="mx-auto max-w-5xl">
        <div className="rounded-[2rem] border border-white/50 bg-[rgba(248,243,236,0.86)] p-8 shadow-[0_24px_80px_rgba(50,31,23,0.08)] backdrop-blur-sm sm:p-10">
      ...
      <section className="mx-auto mt-6 grid max-w-5xl gap-5 md:grid-cols-2">
        {readyCategories.map((category) => (
          <Link
            key={category.slug}
            href={`/${category.slug}`}
            className="group overflow-hidden rounded-[1.7rem] border border-white/50 bg-white/78 shadow-[0_16px_44px_rgba(48,29,19,0.08)] backdrop-blur-sm transition hover:-translate-y-1 hover:shadow-[0_22px_56px_rgba(48,29,19,0.12)]"
          >
